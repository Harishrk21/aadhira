...
const FloatingActionButtons = () => {
  ...
  return (
    <div
      className="fixed bottom-4 right-4 z-50 flex flex-col-reverse items-end gap-3 sm:bottom-5 sm:right-5"
    ...
    >
      <Link
        ...
        className="group flex h-12 w-12 items-center justify-center rounded-full bg-primary-700 text-white shadow-lg shadow-primary-500/30 transition-all duration-300 hover:-translate-y-0.5 hover:bg-primary-800 hover:shadow-xl"
      >
        <CalendarCheck2 className="h-5 w-5 transition-transform duration-300 group-hover:scale-110" />
      </Link>
      ...
      <a
        ...
        className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-green-500 text-white shadow-lg shadow-green-500/30 transition-all duration-300 hover:-translate-y-0.5 hover:bg-green-600 hover:shadow-xl"
