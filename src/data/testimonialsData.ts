...
export const testimonials: Testimonial[] = [
  {
    id: 1,
    quote: "The occupational therapy services at Arura have been transformative for my son. His fine motor skills have improved dramatically, and he's now able to write and draw with much greater confidence. The therapists are patient, skilled, and genuinely care about his progress.",
    author: "Priya R.",
  ...
  {
    id: 2,
    quote: "After just six months of speech therapy at Arura, my daughter went from speaking only a few words to communicating in full sentences. The therapists make the sessions fun and engaging, and they've given us so many useful strategies to practice at home.",
    author: "Arun K.",
  ...
  {
    id: 4,
    quote: "As parents of a child with autism, finding the right support has been challenging. Arura's comprehensive approach with ABA therapy, speech therapy, and occupational therapy has given our son the tools to thrive. We've seen incredible progress in his communication and behavior.",
  ...
  {
    id: 5,
    quote: "The early intervention services we received for our daughter with Down syndrome have been invaluable. The therapists at Arura designed a program specifically for her needs, and they've been alongside us every step of the way. She's now meeting milestones we weren't sure would be possible.",
    author: "Meena T.",
